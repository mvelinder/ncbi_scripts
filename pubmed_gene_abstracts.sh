...
awk -v INPUT=$INPUT '$3 == INPUT' /scratch/ucgd/lustre-work/marth/u0691312/reference/Homo_sapiens.gene_info \
	...
	| cut -f 3 \
	| while read line; do echo $INPUT "https://pubmed.ncbi.nlm.nih.gov/$line"; bash /uufs/chpc.utah.edu/common/HIPAA/u0691312/scripts/pubmed_id_abstract.sh $line; done
